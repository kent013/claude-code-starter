...
| 利用者の発言例 | 起動されるスキル |
|---|---|
| 「環境を診断して」「動作確認して」「doctor して」 | `claude-code-starter-doctor` |
| 「初期セットアップして」「環境構築お願い」 | `claude-code-starter-setup` |
| 「この件について Codex にも意見を聞いてみて」 | `claude-code-starter-codex-review` |
| 「Backlog と連携したい」「GitHub のトークン設定して」 | `claude-code-starter-mcp-setup` |
| 「この TODO を完了にして」 | `claude-code-starter-todo-close` |
