...
| （内部スキル。他スキルが Codex を呼ぶ時の規約なので利用者が直接呼ぶ場面は稀） | `claude-code-starter-codex-vscode` |
...
| 「ドキュメントを最新に更新して」（※ 作者モード `admin_mode=true` 時のみ） | `claude-code-starter-update-docs` |
